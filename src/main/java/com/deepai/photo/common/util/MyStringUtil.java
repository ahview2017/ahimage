...
public class MyStringUtil
{
	...
	public static Integer getIntegerValue(String src){
		if(isNotEmpty(src)){
	...
	public static Long getLongValue(String src){
		if(isNotEmpty(src)){
	...
	public static Boolean getBooleanValue(String src){
		if(isNotEmpty(src)){
			if("0".equals(src)){
				return false;
	...
	public static Byte getByteValue(String src){
		if(isNotEmpty(src)){
	...
	public static String getStringValue(String src){
	 ...
	 //可以判断正负、整数小数
	public static final boolean isNumberOrDouble(String str){
...
//	}
	...
	public static String getFillString(String strIn, int totalLength, boolean isRightAlign)
	{
		...
		spaces = MyStringUtil.getStrSpace(spaceLength);
...
//		s = Replace(s, " ", "&nbsp;");
	...
	*/
	...
	public static boolean isNotBool(String str)
	{
	 ...
	 * @return
	 */
	public static String listStringToString(List<String> arrs)
	{
		StringBuffer result= new StringBuffer("");
	 ...
	 * @return
	 */
	public static String listIntegerToString(List<Integer> arrs)
	{
		StringBuffer result= new StringBuffer("");
		if(arrs != null && arrs.size() >0){
			for(int i=0;i<arrs.size();i++){
	...
	private static MyStringUtil instance = null;
	
	public static synchronized MyStringUtil getInstance()
	{
		if (instance == null)
		{
			instance = new MyStringUtil();
		}
		return instance;
	}
	/**
