 ...
 */
adminModule.controller('projectManageEditCtrl10',function($scope,$cookies,req,md5,$state,$rootScope,$stateParams){
    var vm = this;
    //专题id
    ...
    vm.reqColumnInfo = function () {
        req.post('lanmu/lanMuPicDetail.do',{
            ...
            if(resp.code == '211'){
                ...
                //栏目稿件
                //根据栏目模板显示稿件数量
                vm.manuscript = verdict(resp.data.typeId, resp.data.cpLanmuPictures);
            }
        });
        //栏目更多稿件
