...
clientModule.config(function($stateProvider,$urlRouterProvider,$locationProvider){
    ...
    $stateProvider
        ...
        .state('root', {
            ...
            views:{
                'header':{
                    templateUrl: 'client_ah/app/shared/header/header.html',
                    controller: 'headerCtrl as header'
                },
                'footer':{
                    templateUrl: 'client_ah/app/shared/footer/footer.html',
        ...
        .state('root.index', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_ah/app/components/index/index.html',
